    ...
    const fetchInitialData = async () => {
      try {
        ...
        const subcategoriesData = await publicSubcategoryService.getPublicSubcategories({
          categorySlug: newArrivalsCategory.slug,
        })
    ...
    <div className={`space-y-6 ${isMobile ? "p-6" : ""}`}>
      ...
      {subcategories.length > 0 && (
        <Collapsible defaultOpen>
          <CollapsibleTrigger className="flex items-center justify-between w-full text-sm font-medium mb-3 hover:text-[#6F4E37] transition-colors">
            Subcategories
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                ...
                {filteredProducts.length !== allProducts.length && (
                  <Badge variant="secondary" className="bg-[#6F4E37]/10 text-[#6F4E37]">
                  ...
                  <SheetTrigger asChild>
                    <Button variant="outline" className="lg:hidden w-full sm:w-auto">
                      ...
                      {selectedSubcategories.length +
                        ...
                        0 && (
                        <Badge className="ml-2 bg-[#6F4E37] text-white">
                          {selectedSubcategories.length +
                            selectedBrands.length +
                            selectedColors.length +
                            selectedSizes.length}
                        ...
                        <CardContent className="p-0">
                          ...
                          <div className="p-4">
                            ...
                            <div className="flex items-center gap-4 mb-3">
                              ...
                              {product.sizes && product.sizes.length > 0 && (
                                <div className="flex items-center gap-1">
                                  ...
                                  <span className="text-xs text-gray-700">{product.sizes.slice(0, 2).join(", ")}</span>
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Button
                                size="sm"
                                className="bg-[#6F4E37] hover:bg-[#5d4230] text-white transition-colors"
                          ...
                          {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                            ...
                            return (
                              <Button
                                ...
                                className={currentPage === page ? "bg-[#6F4E37] hover:bg-[#5d4230]" : ""}
                              >
                                {page}
                              </Button>
                            )
